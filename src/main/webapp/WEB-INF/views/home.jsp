...
/*    검색기능 css */
    ...
    .search_input::placeholder {color: white;}
    ...
    .search_icon{height: 30px; width: 30px; float: right; display: flex; justify-content: center; align-items: center; border-radius: 50%; color:white; text-decoration:none;}
    
/*    이달의 작가님 css */
    .contest01 {width: 100%; margin: 0 0 40px 0; padding: 0px; text-align: center; font-size: 30px; font-family: 'Nanum Pen Script', cursive;}
    .card-text {font-size: 16px;}
    
/*    이달의 공모전 css */
    .contest02 {width: 100%; margin: 0 0 40px 0; padding: 0px; text-align: center; font-size: 30px; font-family: 'Nanum Pen Script', cursive;}
    ...
    .lead {font-weight: 500; font-family: 'Nanum Pen Script', cursive; font-size: 26px;}
</style>
<script>
	// === 베스트 공모전 캐러셀 ===
    ...
    <div class="container-fluid p-0">
        <div class="main text-center">
            <div style="position: relative; top: 40%;">
                <div class="text-white" style=" font-size: 4vmin;">저작권 걱정 없이 사용하는 상업용 이미지</div>
                <div class="text-white" style="font-size: 4vmin;">ㅡ</div>
                <div class="text-light mt-4 mb-4">
                    <div class="container h-100">
                      <div class="d-flex justify-content-center h-100">
                        <div class="searchbar">
                          <input class="search_input text-light" type="text" name="" placeholder="이미지 검색 / 두 단어 이상 검색시 띄어쓰기로 구분">
<!--                          <button class="search_icon" style="border: 0px; background-color: #353535;"><i class="fas fa-search"></i></button>-->
                          ...
                          <div class="hashTag m-3">
                              ...
                              <span class="pr-1" style="font-size: 13px;">#새해</span>
...
<!--  Best Pic -->
    <div class="container-fluid p-0">
        <div class="row mt-4 mx-auto px-3">
            <p>
                <span style="font-family: 'Inconsolata', monospace; font-size: 30px;">BEST PIC</span>
            </p>
        </div>
                    ...
                    <div class="MultiCarousel-inner">
                        <div class="item">
                            <div class="pad15">
                                ...
                                <p><button class="btn btn-outline-dark btn-sm">참여하기</button></p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="pad15">
